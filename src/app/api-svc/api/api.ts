...
export const APIS = [AuthControllerService, BannerControllerService, BrandControllerService, CategoryControllerService, ProductControllerService, RoleControllerService, SliderControllerService, TestControllerService, UserControllerService];
