...
export class ProductControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findProductsByBrandName(brandName: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ApiResponseListProduct>;
    public findProductsByBrandName(brandName: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ApiResponseListProduct>>;
    public findProductsByBrandName(brandName: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ApiResponseListProduct>>;
    public findProductsByBrandName(brandName: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (brandName === null || brandName === undefined) {
            throw new Error('Required parameter brandName was null or undefined when calling findProductsByBrandName.');
        }
        ...
        return this.httpClient.get<ApiResponseListProduct>(`${this.configuration.basePath}/api/products/brands/${encodeURIComponent(String(brandName))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
